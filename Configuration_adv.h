 ...
 */
  ...
  #if AXIS_IS_TMC(X)
  //ch changed from 580 to 700 and from 16 to 128 - the maximum speed needs to be changed (by
  //128/16, for example), for these to work at the right speed. And the steps per mm for 
  //each motor also needs to be increased by the same ratio. Haven't done it yet.
  ...
  #if AXIS_IS_TMC(Y)
  //ch changed from 580 and 16 to 700 and 128
  ...
  #if AXIS_IS_TMC(Z)
  //ch changed from 580 to 700, and from 16 to 128
  ...
  #if AXIS_IS_TMC(E0)
  //CH changed from 650 to 700 and from 16 to 128
